<template>
  <div class="body-wrapper">
    ...
    <!-- 显示作业编辑按钮 -->
    <float-fixed
      v-if="!homeworkInfo.i_finished"
      :background="floatFixedBackColor"
    >
      <div @click="displayDoHomework"><span class="iconfont">&#xea2d;</span> 作业</div>
    </float-fixed>
    <!-- 作业编辑弹框 -->
    <div v-transfer-dom>
      <popup v-model="showHomeworkSubmit" position="right" width="100%" >
        <homework-submit
  ...
  export default {
    ...
    methods: {
      ...
      getDetail () {
        ...
        _axios.get('/api/wGuardian/homework/getDetail', {params: requestData}).then(res => {
